...
<head>
    ...
    <script src="<c:url value="/views/js/addInfoScript.js"/>"></script>
</head>
...
<div id="content">
    <form action="${pageContext.servletContext.contextPath}/user/save_photo" method="POST" enctype="multipart/form-data" class="feedback-form-1">
